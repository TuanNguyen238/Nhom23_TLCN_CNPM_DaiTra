...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF204A9C);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFA2AFBD);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF687988);
  late Color primaryBackground = const Color(0xFF161C24);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF1B2128);
  late Color accent2 = const Color(0xFFE6E8E8);
  ...
  late Color lineColor = const Color(0xFF313740);
  late Color tertiaryText = const Color(0xFFB5B6B9);
  late Color black = const Color(0xFF000000);
  late Color textHeading = const Color(0xFF475567);
  late Color customColor1 = const Color(0x00FFFFFF);
}
