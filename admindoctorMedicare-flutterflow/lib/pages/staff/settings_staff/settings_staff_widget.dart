...
import 'settings_staff_model.dart';
export 'settings_staff_model.dart';

class SettingsStaffWidget extends StatefulWidget {
  const SettingsStaffWidget({super.key});

  @override
  State<SettingsStaffWidget> createState() => _SettingsStaffWidgetState();
}

class _SettingsStaffWidgetState extends State<SettingsStaffWidget>
    with TickerProviderStateMixin {
  late SettingsStaffModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsStaffModel());
          ...
          child: Row(
            ...
            children: [
              wrapWithModel(
                ...
                child: const NavMenuStaffWidget(),
              ),
              Expanded(
                child: Container(
