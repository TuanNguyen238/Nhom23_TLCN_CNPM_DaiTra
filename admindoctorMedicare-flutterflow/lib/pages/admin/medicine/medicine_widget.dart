...
class _MedicineWidgetState extends State<MedicineWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().activePage = 'Medicine';
      safeSetState(() {});
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child:
                                                          ...
                                                          onPressed: () async {
                                                            FFAppState().medicines = functions
                                                                .getFilterMedicines(
                                                                    ...
                                                                    (getJsonField(
                                                                      ...
                                                                      r'''$.data''',
                                                                      true,
                                                                    )?.toList().map<MedicineStruct?>(MedicineStruct.maybeFromMap).toList() as Iterable<MedicineStruct?>)
                                                                        .withoutNulls
                                                                        .toList())!
                                                                .toList()
                                                                .cast<MedicineStruct>();
                              ...
                              Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                            ...
                                            children: [
                                                    ...
                                                    textStyle: FlutterFlowTheme
                                                        ...
                                                        .override(
                                                          fontFamily:
                                                              'Open Sans',
                                                          color:
                                                              const Color(0xFF475567),
                                                          fontSize: 14.0,
                                                          letterSpacing: 0.0,
                                                        ),
                                                    elevation: 0.0,
                                                    borderSide: const BorderSide(
                                                      color: Color(0x47556747),
                                                      width: 1.0,
                                                    ),
                                                    borderRadius:
                                              ...
                                              FutureBuilder<ApiCallResponse>(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  final buttonGetAllMedicineAPIResponse =
                                                      snapshot.data!;
                                    ...
                                    Text(
                                      'View on your Medicine infomation',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Open Sans',
                                            color: const Color(0xFF959CAB),
                                            letterSpacing: 0.0,
                                            fontWeight: FontWeight.w500,
                                          ),
                                    ),
                                      ...
                                      return FlutterFlowDataTable<
                                        ...
                                        dataRowBuilder: (medicineItem,
                                          ...
                                          cells: [
                                            ...
                                            Text(
                                              medicineItem.quantity.toString(),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                            ...
                                            RowActionMedicineWidget(
                                              key: Key(
                                                  'Keymkw_${medicineIndex}_of_${medicine.length}'),
