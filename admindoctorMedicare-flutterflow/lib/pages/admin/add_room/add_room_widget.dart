...
class _AddRoomWidgetState extends State<AddRoomWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      // updateAppState
      FFAppState().activePage = 'Add Room';
      safeSetState(() {});
      // callGetAPI
      _model.getOutput = await GetAllExamRoomAPICall.call(
        token: FFAppState().token,
      );

      if ((_model.getOutput?.statusCode ?? 200) == 200) {
        // updatePageState
        FFAppState().examRooms = (getJsonField(
          (_model.getOutput?.jsonBody ?? ''),
          r'''$.data''',
          true,
        )!
                .toList()
                .map<ExamRoomStruct?>(ExamRoomStruct.maybeFromMap)
                .toList() as Iterable<ExamRoomStruct?>)
            .withoutNulls
            .toList()
            .cast<ExamRoomStruct>();
        safeSetState(() {});
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child:
                                                          ...
                                                          onPressed: () async {
                                                            FFAppState().examRooms = functions
                                                                .getFilterExamRooms(
                                                                    ...
                                                                    (getJsonField(
                                                                      ...
                                                                      r'''$.data''',
                                                                      true,
                                                                    )?.toList().map<ExamRoomStruct?>(ExamRoomStruct.maybeFromMap).toList() as Iterable<ExamRoomStruct?>)
                                                                        .withoutNulls
                                                                        .toList())!
                                                                .toList()
                                                                .cast<ExamRoomStruct>();
                              ...
                              Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'View on your Medical Clinic infomation',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Open Sans',
