    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'SettingsDoctor',
          path: '/settingsDoctor',
          builder: (context, params) => SettingsDoctorWidget(),
        ),
        FFRoute(
          name: 'Schedule',
          path: '/schedule',
        ...
        FFRoute(
          ...
          builder: (context, params) => RequirementRequestWidget(),
        ),
        FFRoute(
          name: 'Salary',
          path: '/salary',
          builder: (context, params) => SalaryWidget(),
        ),
        FFRoute(
          name: 'SettingsStaff',
          path: '/settingsStaff',
          builder: (context, params) => SettingsStaffWidget(),
        )
