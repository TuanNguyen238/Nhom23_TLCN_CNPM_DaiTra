...
class _ScheduleWidgetState extends State<ScheduleWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().activePage = 'Schedule';
      safeSetState(() {});
    });
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                _model.getScheduleOutput =
                                    await GetScheduleForDoctorAPICall.call(
                                ...
                                if ((_model.getScheduleOutput?.statusCode ??
                                        200) ==
                                    200) {
                                  FFAppState().schedules = (getJsonField(
                                    (_model.getScheduleOutput?.jsonBody ?? ''),
                                    r'''$.data''',
                                    true,
                                  )!
                                              .toList()
                              ...
                              child: Container(
                                key: ValueKey('ContainerDate_cr7y'),
                                width: 180.0,
                                height: 50.0,
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context)
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final schedule =
                                        FFAppState().schedules.toList();

                                    return FlutterFlowDataTable<ScheduleStruct>(
                                      key: ValueKey('PaginatedDataTable_zq9t'),
                                      controller:
                                      ...
                                      dataRowBuilder: (scheduleItem,
                                        ...
                                        cells: [
                                          ...
                                          Text(
                                            scheduleItem.roomNumber.toString(),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Open Sans',
                                          ...
                                          Text(
                                            scheduleItem.maxPatients.toString(),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Open Sans',
