...
import 'dart:ui';
import 'dialog_detail_requirement_widget.dart'
    show DialogDetailRequirementWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class DialogDetailRequirementModel
    extends FlutterFlowModel<DialogDetailRequirementWidget> {
  ...
  // Stores action output result for [Backend Call - API (approveRequestRecord API)] action in Button widget.
