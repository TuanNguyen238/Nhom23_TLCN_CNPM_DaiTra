...
import 'dialog_detail_appointment_model.dart';
export 'dialog_detail_appointment_model.dart';

class DialogDetailAppointmentWidget extends StatefulWidget {
  const DialogDetailAppointmentWidget({
    super.key,
  ...
  @override
  State<DialogDetailAppointmentWidget> createState() =>
      _DialogDetailAppointmentWidgetState();
}

class _DialogDetailAppointmentWidgetState
    extends State<DialogDetailAppointmentWidget> {
  late DialogDetailAppointmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogDetailAppointmentModel());
