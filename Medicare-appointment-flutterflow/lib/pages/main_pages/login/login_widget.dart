...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.tfPhoneNumberTextController ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: const Color(0xFFD0E4FC),
        body: SafeArea(
          top: true,
          child: Container(
                  ...
                  child: Builder(
                    builder: (context) {
                      if (_model.status == false) {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/doctor-friendship-waving-happily-medical-team-medical-concept-illustration-vector-illustration-flat-style_219363-51.jpg',
                                          width: double.infinity,
                                          height: 250.0,
                                          fit: BoxFit.fill,
                                        ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          's4q8ylzv' /* Người dùng không tồn tại! */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
                                                    ...
                                                    children: [
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'h34aev4z' /* Bạn chưa có tài khoản */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                        ...
                        return Lottie.asset(
                          'assets/jsons/Animation_-_1733287614525.json',
                          width: 500.0,
                          height: 500.0,
                          fit: BoxFit.contain,
                          animate: true,
