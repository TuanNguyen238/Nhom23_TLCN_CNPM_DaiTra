...
import 'dialog_add_medicine_model.dart';
export 'dialog_add_medicine_model.dart';

class DialogAddMedicineWidget extends StatefulWidget {
  const DialogAddMedicineWidget({super.key});

  @override
  State<DialogAddMedicineWidget> createState() =>
      _DialogAddMedicineWidgetState();
}

class _DialogAddMedicineWidgetState extends State<DialogAddMedicineWidget> {
  late DialogAddMedicineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogAddMedicineModel());

    _model.medicinenameTextController ??= TextEditingController();
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 12.0, 0.0, 0.0),
                          child: Text(
                            'Fill in all the information to create a new medicine.',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.isDataUploading != true) {
                            _model.response = await CreateMedicineAPICall.call(
