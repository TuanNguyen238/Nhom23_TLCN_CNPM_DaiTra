...
class _DashboardWidgetState extends State<DashboardWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final chartPieChartColorsList2 = [
      const Color(0xFF446ABC),
      const Color(0xFFFFBF00),
      const Color(0xFFDB7228)
    ];
    final chartPieChartColorsList5 = [
      const Color(0xFF59C3C3),
      const Color(0xFF247BA1),
      const Color(0xFFB6AF8D),
      const Color(0xFFFDBF4A),
      const Color(0xFFF88001),
      const Color(0xFF3E8DD0),
      const Color(0xFFDC67AB),
      const Color(0xFF6772DC),
      const Color(0xFF45F78F),
      const Color(0xFF9E7BBB)
    ];
                          ...
                          children: [
                            Stack(
                              children: [
                                ...
                                Align(
                                  alignment: const AlignmentDirectional(-1.13, 0.0),
                                  child: ClipRRect(
                                          ...
                                          FlutterFlowBarChart(
                                            barData: [
                                              FFBarChartData(
                                                ...
                                                color: const Color(0xFF0187C3),
                                              ),
                                              FFBarChartData(
                                                yData: FFAppState()
                                                    .counMonthDoctor,
                                                color: const Color(0xFF7FB53E),
                                              ),
                                              FFBarChartData(
                                                yData: FFAppState()
                                                    .countMonthAdmin,
                                                color: const Color(0xFFF6AB13),
                                              )
                                            ],
