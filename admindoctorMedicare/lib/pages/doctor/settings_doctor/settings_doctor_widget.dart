...
import 'settings_doctor_model.dart';
export 'settings_doctor_model.dart';

class SettingsDoctorWidget extends StatefulWidget {
  const SettingsDoctorWidget({super.key});

  @override
  State<SettingsDoctorWidget> createState() => _SettingsDoctorWidgetState();
}

class _SettingsDoctorWidgetState extends State<SettingsDoctorWidget>
    with TickerProviderStateMixin {
  late SettingsDoctorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsDoctorModel());
                        ...
                        child: Column(
                          children: [
                            Align(
                              ...
                              child: TabBar(
                                isScrollable: true,
                                labelColor: const Color(0xFF204A9C),
                                ...
                                indicatorColor: const Color(0xFF204A9C),
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    20.0, 0.0, 0.0, 0.0),
                                tabs: const [
                                  Tab(
