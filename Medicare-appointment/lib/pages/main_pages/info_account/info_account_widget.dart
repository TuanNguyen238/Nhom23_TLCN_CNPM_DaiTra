...
import 'info_account_model.dart';
export 'info_account_model.dart';

class InfoAccountWidget extends StatefulWidget {
  const InfoAccountWidget({super.key});

  @override
  State<InfoAccountWidget> createState() => _InfoAccountWidgetState();
}

class _InfoAccountWidgetState extends State<InfoAccountWidget> {
  late InfoAccountModel _model;
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '0wzbr6ll' /* Chỉnh sửa thông tin tài khoản */,
            ),
                          ...
                          if ((_model.updateOutput?.statusCode ?? 200) == 200) {
                            FFAppState().updateUserStruct(
                              (e) => e
                                ...
                                ..email = _model.txtEmailTextController.text
                                ..identifyCard =
                                    _model.txtCCCDTextController.text,
                            );
                          }
