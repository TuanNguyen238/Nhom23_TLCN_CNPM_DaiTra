...
class _EditInfoPatientWidgetState extends State<EditInfoPatientWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      safeSetState(() {
        _model.txtDiachiTextController?.text = _model.location.first;
        _model.txtDiachiFocusNode?.requestFocus();
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _model.txtDiachiTextController?.selection = TextSelection.collapsed(
            offset: _model.txtDiachiTextController!.text.length,
          );
        });
      });
    });
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: custom_widgets.LocationVN(
                            width: double.infinity,
                            height: 210.0,
                            initialProvince: _model.location.last,
                            initialDistrict: _model.location[2],
                            initialWard: _model.location[1],
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
