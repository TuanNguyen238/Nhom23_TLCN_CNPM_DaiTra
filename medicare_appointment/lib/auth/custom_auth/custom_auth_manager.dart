...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    medicareAppointmentAuthUserSubject.add(
      MedicareAppointmentAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MedicareAppointmentAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MedicareAppointmentAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MedicareAppointmentAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    medicareAppointmentAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MedicareAppointmentAuthUser? currentUser;
