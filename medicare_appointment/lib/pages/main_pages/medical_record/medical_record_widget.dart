            ...
            children: [
              wrapWithModel(
                ...
                child: ItemInfoPatientWidget(
                  patient: widget.examination?.patient,
                ),
              ),
              Text(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          formatNumber(
                                            widget.examination?.detailedRecord
                                                .heartRate,
                                            formatType: FormatType.decimal,
                                            decimalType:
                                                DecimalType.commaDecimal,
                          ...
                          child: ExpandableNotifier(
                            ...
                            child: ExpandablePanel(
                              ...
                              expanded: Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    widget.examination?.reasonForVisit,
                                    'reasonForVisit',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                          ...
                          child: ExpandableNotifier(
                            ...
                            child: ExpandablePanel(
                              header: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '5hahbhdo' /* Cận lâm sàng hình ảnh */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .displaySmall
                                      .override(
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'iz3kj6w6' /* Chụp Xquang ngực thẳng */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '9lfaxme5' /* Chụp Xquang ngực thẳng */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                          ...
                          child: ExpandableNotifier(
                            ...
                            child: ExpandablePanel(
                              header: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'ju40l0lf' /* Cận lâm sàng xét nghiệm */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .displaySmall
                                      .override(
                        ...
                        child: Container(
                          ...
                          child: ExpandableNotifier(
                            ...
                            child: ExpandablePanel(
                              ...
                              expanded: Builder(
                                builder: (context) {
                                  final dosages = widget
                                          .examination?.prescription.dosages
                                          .toList() ??
                                      [];

                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: List.generate(dosages.length,
                                        (dosagesIndex) {
                                      final dosagesItem = dosages[dosagesIndex];
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
